...
INSERT INTO `class` (`ID`, `class`, `staff`) VALUES
(1, 'cycle', 'tnt');

-- --------------------------------------------------------

--
-- Table structure for table `classmemberlink`
--

CREATE TABLE `classmemberlink` (
  `ClassMemberID` int(11) NOT NULL,
...
--
-- Indexes for table `classmemberlink`
--
ALTER TABLE `classmemberlink`
...
--
-- AUTO_INCREMENT for table `classmemberlink`
--
ALTER TABLE `classmemberlink`
  MODIFY `ClassMemberID` int(11) NOT NULL AUTO_INCREMENT;
